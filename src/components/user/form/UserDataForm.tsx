...
export default function UserDataForm({
  ...
  return (
    ...
    >
      <Form.Item name="image_url" label={t('User.fields.image_url.label')}>
      ...
      <Row gutter={gutterRow}>
        <Col sm={{ span: spanCol }} xs={{ span: 24 }}>
          <Form.Item name="username" label={t('User.fields.username.label')}>
            <Input placeholder={t('User.fields.username.placeholder')} />
          </Form.Item>
        </Col>
        <Col sm={{ span: spanCol }} xs={{ span: 24 }}>
          <Form.Item name="email" label={t('User.fields.email.label')}>
