...
export const getPatientList: any = {
    data: [
        {
            id: 1,
            fullName: "Samuel Mohasir Barberena Fuentes",
            age: "35",
            teaGrade: 3,
            teaPhase: 2,
            achievementCount: 8,
...
export const getTherapistList: any = {
    data: [
        {
            id: 1,
            fullName: "Little Reislin",
...
export const getObservationList: any = [
    {
